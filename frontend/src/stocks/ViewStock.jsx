...
const ViewStocks = () => {
  ...
  return (
    <>
      <div className="m-3 mt-16 mb-8 md:mt-4 px-4 md:px-10 py-4 bg-gray-100 rounded-tl-lg rounded-tr-lg md:w-400 md:mx-auto">
      ...
      <Routes>
        <Route
          path="/:id"
          element={<EditStockModal stockDetails={stockDetails} />}
        />
      </Routes>
